...
function animate(ts) {
    ...
    canvasCtx.drawImage(IMAGEOBJ, 0, 0, width, height)
    // canvasCtx.drawImage(IMAGEOBJ, 0, 0, 1920, 1080)

    analyser.getFloatFrequencyData(frequencies)

    // currCircleRad = (getCurrVol())
    // const diff = currCircleRad - circleRadius
    // if (diff > 0.5 && diff < 3) {
    //     circleRadius += 2
    // }
    // else if (diff < -0.5 && diff < -3) {
    //     circleRadius -= 2
    // }
    // else {
    //     circleRadius = currCircleRad
    // }
    
    // if (circleRadius > 180) {
    //     circleRadius = 180
    // }
    // else if (circleRadius < 120) {
    //     circleRadius = 120
    // }
...
audioElem.addEventListener('play', audioInit)
